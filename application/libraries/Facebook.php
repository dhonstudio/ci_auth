...
class Facebook
{
    ...
    public function __construct()
    {
        ...
        /*
        | -------------------------------------------------------------------
        | Don't forget to create facebook_helper.php on folder helpers
        | -------------------------------------------------------------------
        | Prototype:
        |
        | <?php
        ...
        */
        ...
        $this->FB = new Facebook\Facebook([
            'app_id' => $this->CI->facebook_config['app_id'],
            'app_secret' => $this->CI->facebook_config['app_secret'],
            'default_graph_version' => $this->CI->facebook_config['default_graph_version'],
        ]);
    }
